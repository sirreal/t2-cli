...
exports['Tessel.prototype.createAccessPoint'] = {
	setUp: function (done) {
		...
		this.createAccessPoint = this.sandbox.spy(
			Tessel.prototype,
			'createAccessPoint',
		);
		this.setLanNetwork = this.sandbox.spy(commands, 'setLanNetwork');
		this.setLanNetworkIfname = this.sandbox.spy(
			commands,
			'setLanNetworkIfname',
		);
		...
		this.setLanNetworkNetmask = this.sandbox.spy(
			commands,
		...
		this.setAccessPointDevice = this.sandbox.spy(
			commands,
			'setAccessPointDevice',
		);
		this.setAccessPointNetwork = this.sandbox.spy(
			commands,
		...
		this.setAccessPointPassword = this.sandbox.spy(
			commands,
			'setAccessPointPassword',
		);
		this.setAccessPointSecurity = this.sandbox.spy(
			commands,
			'setAccessPointSecurity',
		);
	...
	newAccessPoint: function (test) {
		...
		this.sandbox
			...
			.callsFake(function (remoteProcess, callback) {
		...
		this.tessel
			...
			.then(() => {
				...
				test.ok(
					this.setAccessPointPassword.lastCall.calledWith(creds.password),
				);
				test.ok(
					this.setAccessPointSecurity.lastCall.calledWith(creds.security),
				);
...
exports['Tessel.prototype.enableAccessPoint'] = {
	setUp: function (done) {
		...
		this.enableAccessPoint = this.sandbox.spy(
			Tessel.prototype,
			'enableAccessPoint',
		);
		...
		this.reconnectWifi = this.sandbox.spy(commands, 'reconnectWifi');
		this.getAccessPointConfig = this.sandbox.spy(
			commands,
...
exports['Tessel.prototype.disableAccessPoint'] = {
	setUp: function (done) {
		...
		this.spinnerStop = this.sandbox.stub(log.spinner, 'stop');
		this.logInfo = this.sandbox.stub(log, 'info');
		this.disableAccessPoint = this.sandbox.spy(
			Tessel.prototype,
			'disableAccessPoint',
		);
...
exports['Tessel.prototype.getAccessPointInfo'] = {
	setUp: function (done) {
		this.sandbox = sinon.sandbox.create();
		this.getAccessPointInfo = this.sandbox.spy(
			Tessel.prototype,
			'getAccessPointInfo',
		);
		this.getAccessPointConfig = this.sandbox.spy(
